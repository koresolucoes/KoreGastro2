...
const target = `import { InventoryStateService } from '../../services/inventory-state.service';
import { Order } from '../../models/db.models';
import { DashboardVisualizationsComponent } from './dashboard-visualizations.component';`;

const replacement = `import { InventoryStateService } from '../../services/inventory-state.service';
import { Order } from '../../models/db.models';
import { DashboardVisualizationsComponent } from './dashboard-visualizations.component';
