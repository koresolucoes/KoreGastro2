        ...
        <div class="p-3">
          @if (searchQuery().trim() !== '') {
            ...
            <div class="grid grid-cols-2 gap-2">
               <a routerLink="/pos" (click)="closeSearch()" class="flex items-center gap-3 p-3 rounded-xl hover:bg-surface border border-transparent hover:border-subtle group transition-all">
                 <div class="w-10 h-10 rounded-lg bg-brand/10 text-brand flex items-center justify-center group-hover:scale-110 transition-transform">
                   <span translate="no" class="notranslate material-symbols-outlined">point_of_sale</span>
                 </div>
                 <div class="flex-1">
                   <div class="text-sm font-bold text-title">Abrir PDV</div>
                   <div class="text-[10px] text-muted">Iniciar Vendas</div>
                 </div>
               </a>
               <a routerLink="/delivery" (click)="closeSearch()" class="flex items-center gap-3 p-3 rounded-xl hover:bg-surface border border-transparent hover:border-subtle group transition-all">
                 <div class="w-10 h-10 rounded-lg bg-rose-500/10 text-rose-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                   <span translate="no" class="notranslate material-symbols-outlined">local_shipping</span>
                 </div>
                 <div class="flex-1">
                   <div class="text-sm font-bold text-title">Delivery</div>
                   <div class="text-[10px] text-muted">Gerenciar Entregas</div>
                 </div>
               </a>
               <a routerLink="/reports" (click)="closeSearch()" class="flex items-center gap-3 p-3 rounded-xl hover:bg-surface border border-transparent hover:border-subtle group transition-all">
                 <div class="w-10 h-10 rounded-lg bg-blue-500/10 text-blue-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                   <span translate="no" class="notranslate material-symbols-outlined">analytics</span>
                 </div>
                 <div class="flex-1">
                   <div class="text-sm font-bold text-title">Relatórios</div>
                   <div class="text-[10px] text-muted">Ver Desempenho</div>
                 </div>
               </a>
               <a routerLink="/inventory" (click)="closeSearch()" class="flex items-center gap-3 p-3 rounded-xl hover:bg-surface border border-transparent hover:border-subtle group transition-all">
                 <div class="w-10 h-10 rounded-lg bg-emerald-500/10 text-emerald-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                   <span translate="no" class="notranslate material-symbols-outlined">inventory_2</span>
                 </div>
                 <div class="flex-1">
                   <div class="text-sm font-bold text-title">Estoque</div>
                   <div class="text-[10px] text-muted">Visualizar Estoque</div>
                 </div>
               </a>
            </div>
          }
...
content = content.replace(/<div class="flex-1 max-w-xl mx-4 search-container relative hidden md:block">[\s\S]*?<\/div>\n  <\/div>/, searchHtml);
