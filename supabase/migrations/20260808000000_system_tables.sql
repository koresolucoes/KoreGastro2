...
ALTER FUNCTION "public"."adjust_stock"("p_ingredient_id" "uuid", "p_amount" numeric, "p_type" "text", "p_reason" "text", "p_station_id" "uuid", "p_unit_cost" numeric) OWNER TO "postgres";
...
ALTER FUNCTION "public"."authenticate_menu_customer"("p_store_id" "uuid", "p_cpf" "text", "p_password" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."calculate_daily_cmv"("p_user_id" "uuid", "p_date" "date") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_order_with_items"("p_restaurant_id" "uuid", "p_order_data" "jsonb", "p_items" "jsonb", "p_idempotency_key" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_order_id UUID;
...
BEGIN
  -- 1. CHECAGEM DE IDEMPOTÊNCIA (Adicione este bloco no início)
  IF p_idempotency_key IS NOT NULL THEN
    SELECT row_to_json(o) INTO v_existing_order
    FROM orders o
    WHERE idempotency_key = p_idempotency_key AND user_id = p_restaurant_id;

    -- Se o pedido já existir com essa chave, retorna o pedido existente imediatamente
    IF v_existing_order IS NOT NULL THEN
      RETURN v_existing_order;
    END IF;
  END IF;

  -- 2. CRIAÇÃO DO PEDIDO (Modifique sua inserção atual para incluir a chave)
  INSERT INTO orders (
    user_id, 
    -- ... outras colunas que você já insere,
    idempotency_key -- nova coluna
  ) VALUES (
    p_restaurant_id,
    -- ... outros valores,
    p_idempotency_key -- novo valor
  ) RETURNING id INTO v_order_id;

  -- 3. Inserção dos order_items (mantém sua lógica original)
  -- ...
...
ALTER FUNCTION "public"."create_order_with_items"("p_restaurant_id" "uuid", "p_order_data" "jsonb", "p_items" "jsonb", "p_idempotency_key" "text") OWNER TO "postgres";
                                                                                                                    ...
                                                                                                                    completed_at = NOW(),
                                                                                                                            closed_by_employee_id = p_closed_by_employee_id
                                                                                                                                WHERE id = p_order_id;
                                                                                                                                    ...
                                                                                                                                    -- 3. Liberar Mesa (Apenas se não houver outros pedidos abertos para ela)
...
ALTER FUNCTION "public"."get_menu_customer_history"("p_store_id" "uuid", "p_customer_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_menu_customer_profile"("p_store_id" "uuid", "p_customer_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_menu_with_stock"("p_store_id" "uuid", "p_is_available" boolean, "p_category_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_order_by_session"("p_session_token" "uuid") OWNER TO "postgres";
    ...
    IF auth.uid() = target_store_id THEN
        RETURN TRUE;
          END IF;
            ...
            -- B. O usuário tem permissão delegada sincronizada no JWT (Fast Path)
              IF COALESCE((current_setting('request.jwt.claims', true)::jsonb -> 'app_metadata' -> 'stores'), '[]'::jsonb) ? target_store_id::text THEN
                  RETURN TRUE;
                    END IF;

                      -- C. Fallback para processos de backend (Webhooks, cron jobs)
                        IF EXISTS (
...
ALTER FUNCTION "public"."override_order_item_price"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."public_call_waiter"("p_session_token" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."public_request_bill"("p_session_token" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."register_menu_customer"("p_store_id" "uuid", "p_name" "text", "p_phone" "text", "p_cpf" "text", "p_password" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_order_public"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_table_order"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."validate_order_item_price"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."artigos" (
    ...
    "author" "text" DEFAULT 'Equipe ChefOS'::"text" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."employees" (
    ...
    "deleted_at" timestamp with time zone,
    "pix_key" "text",
    CONSTRAINT "employees_salary_type_check" CHECK (("salary_type" = ANY (ARRAY['mensal'::"text", 'horista'::"text", 'freelancer'::"text"])))
);
...
ALTER TABLE "public"."ifood_option_groups" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."ifood_options" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL,
    "ifood_option_group_id" "uuid" NOT NULL,
    "name" "text" NOT NULL,
    "external_code" "text",
...
ALTER TABLE "public"."ifood_options" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."leads" (
    ...
    "aceita_comunicacao" boolean DEFAULT false NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    "tamanho_restaurante" "text"
);
...
ALTER TABLE "public"."menu_item_option_choices" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."menus" (
    ...
    "description" "text",
    "is_active" boolean DEFAULT true,
    "channels" "text"[] DEFAULT ARRAY['PDV'::"text", 'ONLINE'::"text"],
...
CREATE TABLE IF NOT EXISTS "public"."noticias" (
    ...
    "content" "text" NOT NULL,
    "category" "text" NOT NULL,
    "source_name" "text" DEFAULT 'ChefOS News'::"text",
    "source_url" "text",
    "image_url" "text",
    "date" "date" DEFAULT CURRENT_DATE NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."open_delivery_credentials" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."open_delivery_credentials" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."payment_terminals" (
    ...
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    "user_id" "uuid",
    CONSTRAINT "payment_terminals_provider_check" CHECK (("provider" = ANY (ARRAY['cielo_lio'::"text", 'stone'::"text", 'pagseguro'::"text", 'mercado_pago'::"text"])))
);
...
ALTER TABLE "public"."recipe_ifood_option_groups" OWNER TO "postgres";
...
ALTER TABLE "public"."recipe_modifier_groups" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."reservations" (
    ...
    "source" "text" DEFAULT 'IN_PERSON'::"text",
    "occasion" "text",
...
CREATE TABLE IF NOT EXISTS "public"."store_custom_prices" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "recipe_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."store_custom_prices" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."support_ticket_messages" (
    ...
    "text" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    CONSTRAINT "support_ticket_messages_sender_type_check" CHECK (("sender_type" = ANY (ARRAY['client'::"text", 'admin'::"text", 'system'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."support_tickets" (
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    CONSTRAINT "support_tickets_priority_check" CHECK (("priority" = ANY (ARRAY['Baixa'::"text", 'Média'::"text", 'Alta'::"text", 'Urgente'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."whatsapp_agent_configs" (
    ...
    "faq_text" "text",
    "tone" "text" DEFAULT 'CASUAL'::"text",
    "upsell_behavior" "text" DEFAULT 'SUBTLE'::"text",
    "custom_rules" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "agent_tone" "text",
...
ALTER TABLE "public"."whatsapp_agent_configs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."whatsapp_chats" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "whatsapp_chats_status_check" CHECK (("status" = ANY (ARRAY['bot'::"text", 'human'::"text", 'closed'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."whatsapp_messages" (
    ...
    "content" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "whatsapp_messages_sender_type_check" CHECK (("sender_type" = ANY (ARRAY['user'::"text", 'bot'::"text", 'human'::"text"])))
);
...
ALTER TABLE ONLY "public"."ifood_option_groups"
    ADD CONSTRAINT "ifood_option_groups_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ifood_options"
    ADD CONSTRAINT "ifood_options_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."menu_item_option_choices"
    ADD CONSTRAINT "menu_item_option_choices_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."open_delivery_credentials"
    ADD CONSTRAINT "open_delivery_credentials_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."open_delivery_credentials"
    ADD CONSTRAINT "open_delivery_credentials_user_id_key" UNIQUE ("user_id");
...
ALTER TABLE ONLY "public"."recipe_ifood_option_groups"
    ADD CONSTRAINT "recipe_ifood_option_groups_pkey" PRIMARY KEY ("recipe_id", "ifood_option_group_id");
...
ALTER TABLE ONLY "public"."recipe_modifier_groups"
    ADD CONSTRAINT "recipe_modifier_groups_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."recipe_modifier_groups"
    ADD CONSTRAINT "recipe_modifier_groups_recipe_id_group_id_key" UNIQUE ("recipe_id", "group_id");
...
ALTER TABLE ONLY "public"."recipes"
    ADD CONSTRAINT "recipes_store_id_name_key" UNIQUE ("store_id", "name");
...
ALTER TABLE ONLY "public"."store_custom_prices"
    ADD CONSTRAINT "store_custom_prices_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."store_custom_prices"
    ADD CONSTRAINT "store_custom_prices_store_id_recipe_id_key" UNIQUE ("store_id", "recipe_id");
...
ALTER TABLE ONLY "public"."whatsapp_agent_configs"
    ADD CONSTRAINT "whatsapp_agent_configs_pkey" PRIMARY KEY ("store_id");
...
ALTER TABLE ONLY "public"."whatsapp_chats"
    ADD CONSTRAINT "whatsapp_chats_store_id_customer_phone_key" UNIQUE ("store_id", "customer_phone");
...
ALTER TABLE ONLY "public"."whatsapp_configs"
    ADD CONSTRAINT "whatsapp_configs_store_id_key" UNIQUE ("store_id");
...
CREATE INDEX "artigos_category_idx" ON "public"."artigos" USING "btree" ("category");



CREATE INDEX "artigos_slug_idx" ON "public"."artigos" USING "btree" ("slug");
...
CREATE INDEX "idx_custom_prices_recipe_id" ON "public"."store_custom_prices" USING "btree" ("recipe_id");



CREATE INDEX "idx_custom_prices_store_id" ON "public"."store_custom_prices" USING "btree" ("store_id");
...
CREATE INDEX "idx_ifood_webhook_logs_event_code_status" ON "public"."ifood_webhook_logs" USING "btree" ("event_code", "processing_status");



CREATE INDEX "idx_ifood_webhook_logs_ifood_order_id" ON "public"."ifood_webhook_logs" USING "btree" ("ifood_order_id");



CREATE INDEX "idx_ifood_webhook_logs_merchant_id_created_at" ON "public"."ifood_webhook_logs" USING "btree" ("merchant_id", "created_at" DESC);
...
CREATE INDEX "idx_inventory_logs_user_id_ingredient_id" ON "public"."inventory_logs" USING "btree" ("user_id", "ingredient_id", "created_at" DESC);
...
CREATE INDEX "idx_notifications_store_is_read" ON "public"."notifications" USING "btree" ("store_id", "is_read");
...
CREATE INDEX "idx_order_items_order_id_recipe_id" ON "public"."order_items" USING "btree" ("order_id", "recipe_id");
...
CREATE INDEX "idx_orders_session_token" ON "public"."orders" USING "btree" ("session_token");
...
CREATE INDEX "idx_orders_user_id_status_timestamp" ON "public"."orders" USING "btree" ("user_id", "status", "timestamp" DESC);
...
CREATE INDEX "idx_requisitions_target_unit" ON "public"."requisitions" USING "btree" ("target_unit_id");



CREATE INDEX "idx_reservations_user_id_time" ON "public"."reservations" USING "btree" ("user_id", "reservation_time");
...
CREATE INDEX "idx_system_cache_expires_at" ON "public"."system_cache" USING "btree" ("expires_at");
...
CREATE INDEX "idx_time_clock_entries_user_id_clock_in" ON "public"."time_clock_entries" USING "btree" ("user_id", "clock_in_time" DESC);
...
CREATE INDEX "noticias_category_idx" ON "public"."noticias" USING "btree" ("category");



CREATE INDEX "noticias_date_idx" ON "public"."noticias" USING "btree" ("date" DESC);



CREATE INDEX "noticias_slug_idx" ON "public"."noticias" USING "btree" ("slug");
...
CREATE OR REPLACE TRIGGER "formulario chefos ferramentas" AFTER INSERT ON "public"."leads" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://n8n.koresolucoes.com.br/webhook/ea910650-9c6f-444e-b879-b7b5f2cf29f3', 'POST', '{"Content-type":"application/json"}', '{}', '5000');
...
CREATE OR REPLACE TRIGGER "on_owned_store_changed" AFTER INSERT OR DELETE OR UPDATE OF "owner_id" ON "public"."stores" FOR EACH ROW EXECUTE FUNCTION "public"."sync_user_store_permissions"();
...
CREATE OR REPLACE TRIGGER "set_updated_at" BEFORE UPDATE ON "public"."payment_terminals" FOR EACH ROW EXECUTE FUNCTION "public"."handle_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_artigos" BEFORE UPDATE ON "public"."artigos" FOR EACH ROW EXECUTE FUNCTION "public"."handle_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_noticias" BEFORE UPDATE ON "public"."noticias" FOR EACH ROW EXECUTE FUNCTION "public"."handle_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."cashier_closings" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."categories" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."customers" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."ingredient_categories" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."ingredients" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."inventory_lots" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."inventory_movements" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."recipe_preparations" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."roles" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."stations" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."tables" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_updated_at_trigger" BEFORE UPDATE ON "public"."transactions" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "tr_validate_order_item_price" BEFORE INSERT ON "public"."order_items" FOR EACH ROW EXECUTE FUNCTION "public"."validate_order_item_price"();



CREATE OR REPLACE TRIGGER "trigger_override_order_item_price" BEFORE INSERT ON "public"."order_items" FOR EACH ROW EXECUTE FUNCTION "public"."override_order_item_price"();



ALTER TABLE ONLY "public"."assets_depreciation"
    ADD CONSTRAINT "assets_depreciation_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."financial_categories"
    ADD CONSTRAINT "financial_categories_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."ifood_options"
    ADD CONSTRAINT "ifood_options_ifood_option_group_id_fkey" FOREIGN KEY ("ifood_option_group_id") REFERENCES "public"."ifood_option_groups"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."inventory_adjustments"
    ADD CONSTRAINT "inventory_adjustments_ingredient_id_fkey" FOREIGN KEY ("ingredient_id") REFERENCES "public"."ingredients"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_adjustments"
    ADD CONSTRAINT "inventory_adjustments_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_logs"
    ADD CONSTRAINT "inventory_logs_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."inventory_logs"
    ADD CONSTRAINT "inventory_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."inventory_lots"
    ADD CONSTRAINT "inventory_lots_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."inventory_movements"
    ADD CONSTRAINT "inventory_movements_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."label_logs"
    ADD CONSTRAINT "label_logs_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."label_logs"
    ADD CONSTRAINT "label_logs_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."loyalty_movements"
    ADD CONSTRAINT "loyalty_movements_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."loyalty_rewards"
    ADD CONSTRAINT "loyalty_rewards_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."menu_categories"
    ADD CONSTRAINT "menu_categories_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."menu_item_option_choices"
    ADD CONSTRAINT "menu_item_option_choices_menu_item_option_id_fkey" FOREIGN KEY ("menu_item_option_id") REFERENCES "public"."menu_item_option_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_item_option_choices"
    ADD CONSTRAINT "menu_item_option_choices_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_item_option_groups"
    ADD CONSTRAINT "menu_item_option_groups_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_item_option_groups"
    ADD CONSTRAINT "menu_item_option_groups_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_items"
    ADD CONSTRAINT "menu_items_base_recipe_id_fkey" FOREIGN KEY ("base_recipe_id") REFERENCES "public"."recipes"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."menu_items"
    ADD CONSTRAINT "menu_items_menu_category_id_fkey" FOREIGN KEY ("menu_category_id") REFERENCES "public"."menu_categories"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_items"
    ADD CONSTRAINT "menu_items_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menu_items"
    ADD CONSTRAINT "menu_items_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."menus"
    ADD CONSTRAINT "menus_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."modifier_groups"
    ADD CONSTRAINT "modifier_groups_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."modifier_options"
    ADD CONSTRAINT "modifier_options_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."modifier_options"
    ADD CONSTRAINT "modifier_options_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."order_items"
    ADD CONSTRAINT "order_items_added_by_employee_id_fkey" FOREIGN KEY ("added_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."order_items"
    ADD CONSTRAINT "order_items_authorized_by_employee_id_fkey" FOREIGN KEY ("authorized_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."order_items"
    ADD CONSTRAINT "order_items_cancelled_by_fkey" FOREIGN KEY ("cancelled_by") REFERENCES "public"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_cancelled_by_fkey" FOREIGN KEY ("cancelled_by") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_closed_by_employee_id_fkey" FOREIGN KEY ("closed_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_created_by_employee_id_fkey" FOREIGN KEY ("created_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."payment_terminals"
    ADD CONSTRAINT "payment_terminals_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."portioning_event_outputs"
    ADD CONSTRAINT "portioning_event_outputs_ingredient_id_fkey" FOREIGN KEY ("ingredient_id") REFERENCES "public"."ingredients"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."portioning_events"
    ADD CONSTRAINT "portioning_events_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."portioning_events"
    ADD CONSTRAINT "portioning_events_input_ingredient_id_fkey" FOREIGN KEY ("input_ingredient_id") REFERENCES "public"."ingredients"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."promotions"
    ADD CONSTRAINT "promotions_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."purchase_orders"
    ADD CONSTRAINT "purchase_orders_created_by_employee_id_fkey" FOREIGN KEY ("created_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."purchase_orders"
    ADD CONSTRAINT "purchase_orders_received_by_employee_id_fkey" FOREIGN KEY ("received_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."recipe_ifood_option_groups"
    ADD CONSTRAINT "recipe_ifood_option_groups_ifood_option_group_id_fkey" FOREIGN KEY ("ifood_option_group_id") REFERENCES "public"."ifood_option_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."recipe_ifood_option_groups"
    ADD CONSTRAINT "recipe_ifood_option_groups_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."recipe_modifier_groups"
    ADD CONSTRAINT "recipe_modifier_groups_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."modifier_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."recipe_modifier_groups"
    ADD CONSTRAINT "recipe_modifier_groups_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."recipes"
    ADD CONSTRAINT "recipes_store_id_fkey1" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."requisition_items"
    ADD CONSTRAINT "requisition_items_ingredient_id_fkey" FOREIGN KEY ("ingredient_id") REFERENCES "public"."ingredients"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."requisitions"
    ADD CONSTRAINT "requisitions_processed_by_fkey" FOREIGN KEY ("processed_by") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."requisitions"
    ADD CONSTRAINT "requisitions_requested_by_fkey" FOREIGN KEY ("requested_by") REFERENCES "public"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."requisitions"
    ADD CONSTRAINT "requisitions_target_unit_id_fkey" FOREIGN KEY ("target_unit_id") REFERENCES "public"."stores"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."reservations"
    ADD CONSTRAINT "reservations_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."store_custom_prices"
    ADD CONSTRAINT "store_custom_prices_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."store_custom_prices"
    ADD CONSTRAINT "store_custom_prices_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."subscription_invoices"
    ADD CONSTRAINT "subscription_invoices_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."support_tickets"
    ADD CONSTRAINT "support_tickets_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."system_logs"
    ADD CONSTRAINT "system_logs_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."time_clock_entries"
    ADD CONSTRAINT "time_clock_entries_store_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."whatsapp_agent_configs"
    ADD CONSTRAINT "whatsapp_agent_configs_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."whatsapp_chats"
    ADD CONSTRAINT "whatsapp_chats_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."whatsapp_chats"
    ADD CONSTRAINT "whatsapp_chats_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."whatsapp_configs"
    ADD CONSTRAINT "whatsapp_configs_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
CREATE POLICY "Acesso aos precos customizados por permissao" ON "public"."store_custom_prices" USING ((("store_id" = "auth"."uid"()) OR ("store_id" IN ( SELECT "unit_permissions"."store_id"
   FROM "public"."unit_permissions"
  WHERE ("unit_permissions"."manager_id" = "auth"."uid"())))));
...
CREATE POLICY "Clients can create messages for their tickets" ON "public"."support_ticket_messages" FOR INSERT WITH CHECK ((("sender_type" = 'client'::"text") AND ("sender_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."support_tickets"
  WHERE (("support_tickets"."id" = "support_ticket_messages"."ticket_id") AND ("support_tickets"."client_id" = "auth"."uid"()))))));



CREATE POLICY "Clients can create tickets" ON "public"."support_tickets" FOR INSERT WITH CHECK (("client_id" = "auth"."uid"()));



CREATE POLICY "Clients can update their tickets" ON "public"."support_tickets" FOR UPDATE USING (("client_id" = "auth"."uid"()));



CREATE POLICY "Clients can view messages for their tickets" ON "public"."support_ticket_messages" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."support_tickets"
  WHERE (("support_tickets"."id" = "support_ticket_messages"."ticket_id") AND ("support_tickets"."client_id" = "auth"."uid"())))));



CREATE POLICY "Clients can view their tickets" ON "public"."support_tickets" FOR SELECT USING (("client_id" = "auth"."uid"()));
...
CREATE POLICY "Employees can view open delivery credentials for their store" ON "public"."open_delivery_credentials" FOR SELECT USING (("user_id" IN ( SELECT "unit_permissions"."store_id"
   FROM "public"."unit_permissions"
  WHERE ("unit_permissions"."manager_id" = "auth"."uid"())
UNION
 SELECT "employees"."user_id"
   FROM "public"."employees"
  WHERE ("auth"."uid"() IN ( SELECT "unit_permissions"."manager_id"
           FROM "public"."unit_permissions"
          WHERE ("unit_permissions"."store_id" = "employees"."user_id"))))));



CREATE POLICY "Enable ALL for users based on user_id" ON "public"."ifood_option_groups" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Enable ALL for users based on user_id" ON "public"."ifood_options" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Enable ALL for users based on user_id" ON "public"."recipe_ifood_option_groups" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Enable all based on user_id" ON "public"."menu_categories" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Enable all based on user_id" ON "public"."menu_item_option_choices" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Enable all based on user_id" ON "public"."menu_item_option_groups" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Enable all based on user_id" ON "public"."menu_items" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Enable all based on user_id" ON "public"."menus" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Enable read for authenticated users on chats" ON "public"."whatsapp_chats" FOR SELECT USING (true);



CREATE POLICY "Enable read for authenticated users on configs" ON "public"."whatsapp_configs" FOR SELECT USING (true);



CREATE POLICY "Enable read for authenticated users on messages" ON "public"."whatsapp_messages" FOR SELECT USING (true);
...
CREATE POLICY "Enable write for authenticated users on chats" ON "public"."whatsapp_chats" USING (true);



CREATE POLICY "Enable write for authenticated users on configs" ON "public"."whatsapp_configs" USING (true);



CREATE POLICY "Enable write for authenticated users on messages" ON "public"."whatsapp_messages" USING (true);
...
CREATE POLICY "Multi-tenant access" ON "public"."cashier_closings" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."categories" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."employees" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."halls" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."ingredient_categories" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."ingredients" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."inventory_movements" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."order_items" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."orders" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."payment_terminals" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."recipe_ingredients" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."recipe_preparations" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."recipes" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."stations" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."suppliers" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."tables" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));



CREATE POLICY "Multi-tenant access" ON "public"."transactions" USING ("public"."has_access_to_store"("user_id")) WITH CHECK ("public"."has_access_to_store"("user_id"));
...
CREATE POLICY "Permitir Matriz atualizar requisições inter-company" ON "public"."requisitions" FOR UPDATE USING ((("target_unit_id" = "auth"."uid"()) OR ("target_unit_id" IN ( SELECT "unit_permissions"."store_id"
   FROM "public"."unit_permissions"
  WHERE ("unit_permissions"."manager_id" = "auth"."uid"())))));



CREATE POLICY "Permitir Matriz ler requisições inter-company" ON "public"."requisitions" FOR SELECT USING ((("target_unit_id" = "auth"."uid"()) OR ("target_unit_id" IN ( SELECT "unit_permissions"."store_id"
   FROM "public"."unit_permissions"
  WHERE ("unit_permissions"."manager_id" = "auth"."uid"())))));



CREATE POLICY "Permitir atualização apenas para administradores autenticados" ON "public"."artigos" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Permitir atualização apenas para administradores autenticados" ON "public"."noticias" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Permitir atualização de terminais para dono" ON "public"."payment_terminals" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Permitir deleção de terminais para dono" ON "public"."payment_terminals" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Permitir exclusão apenas para administradores autenticados" ON "public"."artigos" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Permitir exclusão apenas para administradores autenticados" ON "public"."noticias" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Permitir inserts publicos na tabela beta_testers" ON "public"."beta_testers" FOR INSERT WITH CHECK (true);



CREATE POLICY "Permitir inserção apenas para administradores autenticados" ON "public"."artigos" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Permitir inserção apenas para administradores autenticados" ON "public"."noticias" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Permitir inserção de terminais para dono" ON "public"."payment_terminals" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Permitir leitura apenas para autenticados" ON "public"."leads" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Permitir leitura de terminais para usuários do tenant" ON "public"."payment_terminals" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR ("user_id" IN ( SELECT "employees"."user_id"
   FROM "public"."employees"
...
CREATE POLICY "Permitir leitura pública condicional (option groups)" ON "public"."ifood_option_groups" FOR SELECT USING (true);



CREATE POLICY "Permitir leitura pública condicional (options)" ON "public"."ifood_options" FOR SELECT USING (true);



CREATE POLICY "Permitir leitura pública condicional (recipe groups)" ON "public"."recipe_ifood_option_groups" FOR SELECT USING (true);
...
CREATE POLICY "Permitir leitura pública de artigos" ON "public"."artigos" FOR SELECT USING (true);
...
CREATE POLICY "Permitir leitura pública de itens de pedido" ON "public"."order_items" FOR SELECT USING (false);



CREATE POLICY "Permitir leitura pública de notícias" ON "public"."noticias" FOR SELECT USING (true);



CREATE POLICY "Permitir leitura pública de pedidos" ON "public"."orders" FOR SELECT USING (false);
...
CREATE POLICY "Public can insert order modifiers" ON "public"."order_item_modifiers" FOR INSERT WITH CHECK (true);



CREATE POLICY "Public can view modifier groups" ON "public"."modifier_groups" FOR SELECT USING (true);



CREATE POLICY "Public can view modifiers" ON "public"."modifiers" FOR SELECT USING (true);



CREATE POLICY "Public can view recipe modifiers" ON "public"."recipe_modifier_groups" FOR SELECT USING (true);



CREATE POLICY "Public insertion allowed ONLY into OPEN orders" ON "public"."order_items" FOR INSERT TO "anon" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."orders" "o"
  WHERE (("o"."id" = "order_items"."order_id") AND ("o"."status" = 'OPEN'::"text")))));
...
CREATE POLICY "System admins read access" ON "public"."system_admins" FOR SELECT USING ((("auth"."jwt"() ->> 'email'::"text") IN ( SELECT "system_admins_1"."email"
   FROM "public"."system_admins" "system_admins_1")));



CREATE POLICY "System cache access" ON "public"."system_cache" USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can delete requisition items of their own restaurant" ON "public"."requisition_items" FOR DELETE USING (("public"."has_access_to_store"("user_id") OR (EXISTS ( SELECT 1
   FROM "public"."requisitions" "r"
  WHERE (("r"."id" = "requisition_items"."requisition_id") AND ("r"."target_unit_id" IS NOT NULL) AND "public"."has_access_to_store"("r"."target_unit_id"))))));



CREATE POLICY "Users can delete requisitions of their own restaurant" ON "public"."requisitions" FOR DELETE USING (("public"."has_access_to_store"("user_id") OR (("target_unit_id" IS NOT NULL) AND "public"."has_access_to_store"("target_unit_id"))));
...
CREATE POLICY "Users can delete their own agent configs" ON "public"."whatsapp_agent_configs" FOR DELETE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
...
CREATE POLICY "Users can delete their store notifications" ON "public"."notifications" FOR DELETE USING (true);
...
CREATE POLICY "Users can insert requisition items for their own restaurant" ON "public"."requisition_items" FOR INSERT WITH CHECK (("public"."has_access_to_store"("user_id") OR (EXISTS ( SELECT 1
   FROM "public"."requisitions" "r"
  WHERE (("r"."id" = "requisition_items"."requisition_id") AND ("r"."target_unit_id" IS NOT NULL) AND "public"."has_access_to_store"("r"."target_unit_id"))))));
...
CREATE POLICY "Users can insert their own agent configs" ON "public"."whatsapp_agent_configs" FOR INSERT WITH CHECK (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."owner_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can insert their own system logs" ON "public"."system_logs" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage modifiers of their groups" ON "public"."modifiers" USING ((EXISTS ( SELECT 1
   FROM "public"."modifier_groups"
  WHERE (("modifier_groups"."id" = "modifiers"."group_id") AND ("modifier_groups"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can manage recipe modifiers" ON "public"."recipe_modifier_groups" USING ((EXISTS ( SELECT 1
   FROM "public"."recipes"
  WHERE (("recipes"."id" = "recipe_modifier_groups"."recipe_id") AND ("recipes"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can manage their own Open Delivery credentials" ON "public"."open_delivery_credentials" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can manage their own modifier groups" ON "public"."modifier_groups" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update requisition items of their own restaurant" ON "public"."requisition_items" FOR UPDATE USING (("public"."has_access_to_store"("user_id") OR (EXISTS ( SELECT 1
   FROM "public"."requisitions" "r"
  WHERE (("r"."id" = "requisition_items"."requisition_id") AND ("r"."target_unit_id" IS NOT NULL) AND "public"."has_access_to_store"("r"."target_unit_id"))))));
...
CREATE POLICY "Users can update their own agent configs" ON "public"."whatsapp_agent_configs" FOR UPDATE USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."owner_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update their store notifications" ON "public"."notifications" FOR UPDATE USING (true);



CREATE POLICY "Users can view modifiers of their orders" ON "public"."order_item_modifiers" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."order_items" "oi"
...
CREATE POLICY "Users can view notifications for their store" ON "public"."notifications" FOR SELECT USING (true);
...
CREATE POLICY "Users can view their own agent configs" ON "public"."whatsapp_agent_configs" FOR SELECT USING (("store_id" IN ( SELECT "stores"."id"
   FROM "public"."stores"
  WHERE ("stores"."owner_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view their own invoices" ON "public"."subscription_invoices" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view their own system logs" ON "public"."system_logs" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
ALTER TABLE "public"."open_delivery_credentials" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."store_custom_prices" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."adjust_stock"("p_ingredient_id" "uuid", "p_amount" numeric, "p_type" "text", "p_reason" "text", "p_station_id" "uuid", "p_unit_cost" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."adjust_stock"("p_ingredient_id" "uuid", "p_amount" numeric, "p_type" "text", "p_reason" "text", "p_station_id" "uuid", "p_unit_cost" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."adjust_stock"("p_ingredient_id" "uuid", "p_amount" numeric, "p_type" "text", "p_reason" "text", "p_station_id" "uuid", "p_unit_cost" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."authenticate_menu_customer"("p_store_id" "uuid", "p_cpf" "text", "p_password" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."authenticate_menu_customer"("p_store_id" "uuid", "p_cpf" "text", "p_password" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."authenticate_menu_customer"("p_store_id" "uuid", "p_cpf" "text", "p_password" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."calculate_daily_cmv"("p_user_id" "uuid", "p_date" "date") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_daily_cmv"("p_user_id" "uuid", "p_date" "date") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_daily_cmv"("p_user_id" "uuid", "p_date" "date") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_order_with_items"("p_restaurant_id" "uuid", "p_order_data" "jsonb", "p_items" "jsonb", "p_idempotency_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_order_with_items"("p_restaurant_id" "uuid", "p_order_data" "jsonb", "p_items" "jsonb", "p_idempotency_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_order_with_items"("p_restaurant_id" "uuid", "p_order_data" "jsonb", "p_items" "jsonb", "p_idempotency_key" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_menu_customer_history"("p_store_id" "uuid", "p_customer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_menu_customer_history"("p_store_id" "uuid", "p_customer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_menu_customer_history"("p_store_id" "uuid", "p_customer_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_menu_customer_profile"("p_store_id" "uuid", "p_customer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_menu_customer_profile"("p_store_id" "uuid", "p_customer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_menu_customer_profile"("p_store_id" "uuid", "p_customer_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_menu_with_stock"("p_store_id" "uuid", "p_is_available" boolean, "p_category_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_menu_with_stock"("p_store_id" "uuid", "p_is_available" boolean, "p_category_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_menu_with_stock"("p_store_id" "uuid", "p_is_available" boolean, "p_category_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_order_by_session"("p_session_token" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_order_by_session"("p_session_token" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_order_by_session"("p_session_token" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."override_order_item_price"() TO "anon";
GRANT ALL ON FUNCTION "public"."override_order_item_price"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."override_order_item_price"() TO "service_role";



GRANT ALL ON FUNCTION "public"."public_call_waiter"("p_session_token" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."public_call_waiter"("p_session_token" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."public_call_waiter"("p_session_token" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."public_request_bill"("p_session_token" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."public_request_bill"("p_session_token" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."public_request_bill"("p_session_token" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."register_menu_customer"("p_store_id" "uuid", "p_name" "text", "p_phone" "text", "p_cpf" "text", "p_password" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."register_menu_customer"("p_store_id" "uuid", "p_name" "text", "p_phone" "text", "p_cpf" "text", "p_password" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."register_menu_customer"("p_store_id" "uuid", "p_name" "text", "p_phone" "text", "p_cpf" "text", "p_password" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_order_public"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_order_public"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_order_public"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_table_order"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_table_order"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_table_order"("p_order_id" "uuid", "p_customer_name" "text", "p_notes" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."validate_order_item_price"() TO "anon";
GRANT ALL ON FUNCTION "public"."validate_order_item_price"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_order_item_price"() TO "service_role";
...
GRANT ALL ON TABLE "public"."artigos" TO "anon";
GRANT ALL ON TABLE "public"."artigos" TO "authenticated";
GRANT ALL ON TABLE "public"."artigos" TO "service_role";
...
GRANT ALL ON TABLE "public"."ifood_option_groups" TO "anon";
GRANT ALL ON TABLE "public"."ifood_option_groups" TO "authenticated";
GRANT ALL ON TABLE "public"."ifood_option_groups" TO "service_role";



GRANT ALL ON TABLE "public"."ifood_options" TO "anon";
GRANT ALL ON TABLE "public"."ifood_options" TO "authenticated";
GRANT ALL ON TABLE "public"."ifood_options" TO "service_role";
...
GRANT ALL ON TABLE "public"."menu_item_option_choices" TO "anon";
GRANT ALL ON TABLE "public"."menu_item_option_choices" TO "authenticated";
GRANT ALL ON TABLE "public"."menu_item_option_choices" TO "service_role";



GRANT ALL ON TABLE "public"."menu_item_option_groups" TO "anon";
GRANT ALL ON TABLE "public"."menu_item_option_groups" TO "authenticated";
...
GRANT ALL ON TABLE "public"."open_delivery_credentials" TO "anon";
GRANT ALL ON TABLE "public"."open_delivery_credentials" TO "authenticated";
GRANT ALL ON TABLE "public"."open_delivery_credentials" TO "service_role";
...
GRANT ALL ON TABLE "public"."payment_terminals" TO "anon";
GRANT ALL ON TABLE "public"."payment_terminals" TO "authenticated";
GRANT ALL ON TABLE "public"."payment_terminals" TO "service_role";
...
GRANT ALL ON TABLE "public"."recipe_ifood_option_groups" TO "anon";
GRANT ALL ON TABLE "public"."recipe_ifood_option_groups" TO "authenticated";
GRANT ALL ON TABLE "public"."recipe_ifood_option_groups" TO "service_role";
...
GRANT ALL ON TABLE "public"."recipe_modifier_groups" TO "anon";
GRANT ALL ON TABLE "public"."recipe_modifier_groups" TO "authenticated";
GRANT ALL ON TABLE "public"."recipe_modifier_groups" TO "service_role";
...
GRANT ALL ON TABLE "public"."store_custom_prices" TO "anon";
GRANT ALL ON TABLE "public"."store_custom_prices" TO "authenticated";
GRANT ALL ON TABLE "public"."store_custom_prices" TO "service_role";
...
GRANT ALL ON TABLE "public"."whatsapp_agent_configs" TO "anon";
GRANT ALL ON TABLE "public"."whatsapp_agent_configs" TO "authenticated";
GRANT ALL ON TABLE "public"."whatsapp_agent_configs" TO "service_role";
...
GRANT ALL ON TABLE "public"."whatsapp_configs" TO "anon";
GRANT ALL ON TABLE "public"."whatsapp_configs" TO "authenticated";
GRANT ALL ON TABLE "public"."whatsapp_configs" TO "service_role";
