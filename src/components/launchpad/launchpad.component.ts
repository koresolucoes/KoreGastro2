  ...
  private allCategories: LaunchpadCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Criador de Cardápios', path: '/menu-builder', icon: 'restaurant_menu', color: 'bg-emerald-600 shadow-emerald-600/20', description: 'Monte seu cardápio com opções e complementos.' },
