...
export class BottomNavComponent {
  ...
  allNavItems: NavItem[] = [
    ...
    { name: 'Escalas', path: '/schedules', icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18', roles: ['Gerente'] },
